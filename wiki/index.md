...
- [[overview|Overview]] — Living synthesis of the whole knowledge base
...
- [[concepts/memex|Memex]] — Bush's vision of a private curated store with associative trails
- [[concepts/ingest|Ingest]] — Operation: read a raw source, integrate into wiki pages, update index/log
...
- [[concepts/value-creation-vs-value-capture|Value Creation vs Value Capture]] — Disrupting ≠ owning; DeepSeek create vs US enterprise capture
...
- [[comparisons/rag-vs-llm-wiki|RAG vs LLM Wiki]] — Rediscovery at query time vs compiled persistent knowledge
